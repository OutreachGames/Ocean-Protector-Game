...
MYG.COLOR_MEDIUM_BLUE = vmath.vector4(0.70, 0.80, 1.0, 1)
MYG.COLOR_CONTRAST_BLUE = vmath.vector4(0.55, 0.84, 1.1, 1)

MYG.COLOR_HOVER = MYG.COLOR_CONTRAST_BLUE --vmath.vector4(1.15, 1.15, 1.15, 1)
